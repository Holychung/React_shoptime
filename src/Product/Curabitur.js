...
import './Curabitur.css'

class Curabitur extends React.Component{
  render(){
    return(
      <div className="product-item-2 d-flex px-4 mt-3 text-left">
        <span className="col-3 pl-0 d-flex">
          ...
          <span className="mx-2 mt-2">Curabitur lobo.</span>
        </span>
