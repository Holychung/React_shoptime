    ...
    return(
      <div className="product-item-1 d-flex px-4 mt-3 text-left">
        <span className="col-3 pl-0 d-flex">
          ...
          <span className="mx-2 mt-2">Lobo</span>
        </span>
        ...
        <span className="col-1 mt-2">
          ...
          <div className="dropdown">
            <a className="btn btn-unpublished dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              UNPUBLISHED
            </a>
