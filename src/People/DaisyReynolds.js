...
import './DaisyReynolds.css'

class DaisyReynolds extends React.Component{
  render(){
    return(
      <div className="order-item-6 d-flex pt-3">
        ...
        <span className="col-1">
          <div className="dropdown">
            <a className="btn btn-unpaid dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              UNPAID
            </a>
