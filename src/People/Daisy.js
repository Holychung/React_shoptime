...
class Daisy extends React.Component{
  render(){
    return(
      <div className="order-item-3 d-flex pt-3">
        ...
        <span className="col-1">
          <div className="dropdown">
            <a className="btn btn-shipping dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              SHIPPING
            </a>
